...
import { Ticket, Monitor, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-navy-dark via-navy to-navy-light">
      ...
      <header className="p-8 text-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-primary-foreground">
            ...
            <h1 className="text-gold text-3xl md:text-4xl font-bold tracking-wide">
      ...
      <main className="max-w-5xl mx-auto px-6 pb-12">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          {menuItems.map((item) => (
            <Link key={item.href} to={item.href} className="group w-full">
              <Card className="h-full bg-card/10 backdrop-blur-md border-gold/20 hover:border-gold/50 transition-all duration-300 hover:shadow-glow hover:-translate-y-1">
                <CardHeader className="text-center pb-2">
                  <div
                    className={`w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center mb-4 shadow-elevated group-hover:scale-110 transition-transform`}
                  >
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-6">
          <Card className="bg-card/10 backdrop-blur-md border-gold/20">
            ...
            <CardContent className="text-primary-foreground/70 space-y-2 text-sm">
              ...
              <p>2. <strong className="text-gold">Display</strong> - Tampilkan di TV ruang tunggu</p>
            </CardContent>
          </Card>
      ...
      <footer className="bg-navy-dark/50 backdrop-blur-sm border-t border-gold/20 p-6">
        <p className="text-center text-primary-foreground/50 text-sm">
          © 2025 Sistem Antrian Digital - Rutan Kelas 1 Depok
        </p>
      </footer>
    </div>
  );
